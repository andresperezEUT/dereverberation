...
result_folder_path = os.path.join('/Users/andres.perez/source/dereverberation/experiment/results', instrument)
...
# The drums baseline data was scaled according to the following parameters:
# m1, n1 = (6.123920485012435, -1.2566895887421592)
# Most recent analysis yields slightly different values
# m2, n2 = (8.242079921128573, -2.193882033832822)
## Corrections for each instrument, according to the experiment
## drums: (1.3458829096981388, -0.5025249935491676) --> only re-correction!
