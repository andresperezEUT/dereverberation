"""
experiment/analysis_dev_baseline.py
TODo
...
result_folder_path = os.path.join('/Users/andres.perez/source/dereverberation/experiment/results_dev_baseline', instrument)
